...
class _create_passwordState extends State<create_password> {
  ...
  bool _showPassword2 = false; // Variable para controlar la visibilidad de la confirmación de contraseña
  TextEditingController password = TextEditingController(); // Controlador para el campo de contraseña
  TextEditingController confirmpassword = TextEditingController(); // Controlador para el campo de confirmación de contraseña
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          TextFormField(
                            //se está solicitando al usuario que ingrese una contraseña.
                            // Se muestra un campo de texto en el que el usuario puede ingresar la contraseña.
                            // Se realiza una validación en el campo de texto para asegurarse de que no esté vacío y que tenga al menos 8 caracteres.
                            controller: password,
                            validator: (valor) {
                              if (valor!.isEmpty) {
