                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 20.0), // Espacio vertical
                              Wrap(
                              ...
                              TextFormField(
                                ...
                                validator: (valor) {
                                  ...
                                  if (valor!.length == 0) {
                                    return 'Please input your email'; // Mensaje de validación para el campo de email vacío
                                  } else if (!regExp.hasMatch(valor)) {
                                    return 'Your email is not valid'; // Mensaje de validación para el formato de email incorrecto
                                  }
                                  return null;
                                },
                              ...
                              const SizedBox(height: 30.0), // Espacio vertical
                              const SizedBox(height: 30.0), // Espacio vertical
      ...
      await showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            actions: [
              TextButton(
                child: Text("Accept"), // Texto del botón de aceptar
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (
                          context) => const Login(), // Navegar a la pantalla de inicio de sesión
                    ),
                  );
                },
              ),
      ...
      await showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            // Título del diálogo
            content: Text(
                "No account found with that email address, do you want to create a new account?"),
            // Contenido del diálogo
            actions: [
              TextButton(
                child: Text("Accept"), // Texto del botón de aceptar
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (
                          context) => const SignUp(), // Navegar a la pantalla de registro
                    ),
                  );
                },
              ),
              TextButton(
                ...
                child: const Text('Cancel'), // Texto del botón de cancelar
              ),
            ],
          );
        },
