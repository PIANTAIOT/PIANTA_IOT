...
// Definición de la clase "reset_passaword" que extiende de StatefulWidget.
class reset_passaword extends StatefulWidget {
  const reset_passaword({Key? key}) : super(key: key);

  // Override del método "createState" para crear y devolver una instancia del estado de "reset_passaword".
  @override
  State<reset_passaword> createState() => _reset_passawordState();
}

// Estado privado de la clase "reset_passaword".
class _reset_passawordState extends State<reset_passaword> {
  // Declaración de una clave global para el formulario.
