...
class _profileState extends State<profile> {
  ...
  TextEditingController usernames = TextEditingController(); // Controlador para el campo de texto de los nombres de usuario

  void _saveUsername(String username) async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString('username', username); // Guarda el nombre de usuario en las preferencias compartidas
  }
                                ...
                                child: ElevatedButton(
                                  onPressed: () async {
                                    if (_keyForm.currentState!.validate()) {
                                      ...
                                      final prefs = await SharedPreferences.getInstance();
                                      final storedEmail = prefs.getString('email'); // Obtener el correo electrónico almacenado
                                      _checkEmailExists(usernames.text, storedEmail!); // Verificar si el nombre de usuario ya existe
...
*/
                                   ...
                                   */
                                      ...
                                      //si no se digita pedire que cree unusuario
...
void createUser(BuildContext context) async {
  final prefs = await SharedPreferences.getInstance();
  final storedEmail = prefs.getString('email'); // Obtener el correo electrónico almacenado
  final storedPassword = prefs.getString('password'); // Obtener la contraseña almacenada
  final storedUsername = prefs.getString('username'); // Obtener el nombre de usuario almacenado
  ...
  // Eliminar los valores almacenados en las preferencias compartidas
