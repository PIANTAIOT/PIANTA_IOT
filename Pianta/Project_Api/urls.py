...
from .views import DevicesListApiView, ProjectDetailApiView, ProjectListApiView, DevicesDetailApiView, TemplateDetailApiView, TemplateListApiView, SharedProjectView, ShareProjectView, save_DatosSensores, obtener_datos_sensores, datos_sensores, DeleteSharedProjectView, SharedProjectList#, SharedrandonView
